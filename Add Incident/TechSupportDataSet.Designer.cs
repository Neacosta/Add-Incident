...
SELECT IncidentID, CustomerID, ProductCode, DateOpened, Title, Description FROM Incidents WHERE (IncidentID = @IncidentID)";
    ...
    public partial class ProductsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = @"SELECT Products.ProductCode, Products.Name, Registrations.CustomerID, Products.Version, Products.ReleaseDate
...
WHERE  (Registrations.CustomerID = @CustomerID)";
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int FillByProductRegistration(TechSupportDataSet.ProductsDataTable dataTable, int CustomerID) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            this.Adapter.SelectCommand.Parameters[0].Value = ((int)(CustomerID));
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
